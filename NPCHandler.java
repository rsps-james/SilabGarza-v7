...
if(npcs[i].npcType == 1645 || npcs[i].npcType == 509 || npcs[i].npcType == 1241 || npcs[i].npcType == 1246 || npcs[i].npcType == 1159 || npcs[i].npcType == 54)
                    ...
                    if (npcs[i].npcType == 2253) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "Download the client at www.sgclient.tk!";
                        }
                    }
                    if (npcs[i].npcType == 2475) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "LOOTING IS ALOUD!!!!";
                        }
                    }
                    if (npcs[i].npcType == 1783) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "use chisel on box 4 armor!";
                        }
                    }
                    if (npcs[i].npcType == 28) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "minin shop/train portal!";
                        }
                    }
                    if (npcs[i].npcType == 558) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "Initiate/Gilded Store!";
                        }
                    }
                    ...
                    if (npcs[i].npcType == 1699) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "Pure Gear!";
                        }
                    }
                    if (npcs[i].npcType == 585) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "Crafting Shop!";
                        }
                    }
                    ...
                    if (npcs[i].npcType == 555) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "Skill Capes Store!";
                        }
                    }
                    if (npcs[i].npcType == 213) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "kil trol 4 key den use on portal!";
                        }
                    }
                    if (npcs[i].npcType == 3103) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "1v1 Zone, PJ AND TEAMING RESULTS IN BAN!";
                        }
                    }
                    if (npcs[i].npcType == 3104) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "Dont run or u wil b considered a nub!";
                        }
                    }
                    if (npcs[i].npcType == 3117) {
                        if (misc.random2(30) <= 2) {
                            npcs[i].updateRequired = true;
                            npcs[i].textUpdateRequired = true;
                            npcs[i].textUpdate = "Kill the monsters for slayer EXP!";
                        }
                    }
    ...
    public void MonsterDropItem(int NPCID) { {
            if (IsDropping == false) {
				...
				ppl.addSkillXP((500), 18);
                            }

                            if (npcs[NPCID].npcType == 90) {
                                int Player = npcs[NPCID].StartKilling;
                                client ppl = (client) server.playerHandler.players[Player];
				ppl.addSkillXP((1000), 18);
                            }
				...
				ppl.addSkillXP((10000), 18);
                            ...
                            if (npcs[NPCID].npcType == 1604) {
                                int Player = npcs[NPCID].StartKilling;
                                client ppl = (client) server.playerHandler.players[Player];
				ppl.addSkillXP((15000), 18);
                            }
                            if (npcs[NPCID].npcType == 1615) {
                                int Player = npcs[NPCID].StartKilling;
                                client ppl = (client) server.playerHandler.players[Player];
				ppl.addSkillXP((25000), 18);
                            }
                            if (npcs[NPCID].npcType == 2783) {
                                int Player = npcs[NPCID].StartKilling;
                                client ppl = (client) server.playerHandler.players[Player];
				ppl.addSkillXP((50000), 18);
                            }
                            if (npcs[NPCID].npcType == 2169) {
                                int Player = npcs[NPCID].StartKilling;
                                client ppl = (client) server.playerHandler.players[Player];
				ppl.addSkillXP((100000), 18);
                            }
                            ...
                            if (npcs[NPCID].npcType == 114) // ogre
                            {
                                ItemHandler.addItem(Item2.randomOGRE(),
                                        npcs[NPCID].absX, npcs[NPCID].absY, 1,
                                        GetNpcKiller(NPCID), false);
                            }
                            if (npcs[NPCID].npcType == 3071) // wyvern
                            {
                                ItemHandler.addItem(Item2.randomWyvern(),
                                        npcs[NPCID].absX, npcs[NPCID].absY, 1,
                                        GetNpcKiller(NPCID), false);
                            }
                            if (npcs[NPCID].npcType == 2883) // dag
                            {
                                ItemHandler.addItem(Item2.randomDAG3(),
                                        npcs[NPCID].absX, npcs[NPCID].absY, 1,
                                        GetNpcKiller(NPCID), false);
                            }
                            if (npcs[NPCID].npcType == 2882) // dag
                            {
                                ItemHandler.addItem(Item2.randomDAG2(),
                                        npcs[NPCID].absX, npcs[NPCID].absY, 1,
                                        GetNpcKiller(NPCID), false);
                            }
                            if (npcs[NPCID].npcType == 2881) // dag
                            {
                                ItemHandler.addItem(Item2.randomDAG1(),
                                        npcs[NPCID].absX, npcs[NPCID].absY, 1,
                                        GetNpcKiller(NPCID), false);
                            }
                            ...
                            if (npcs[NPCID].npcType == 1645) {
                                ItemHandler.addItem(Item2.randomInfernalMage(),
                                        npcs[NPCID].absX, npcs[NPCID].absY, 1,
                                        GetNpcKiller(NPCID), false);
                            }
