...
public class TextHandler { 
    ...
    public void process(int a) {
        ...
        p.sendFrame126("@red@Pk", 177);
        p.sendFrame126("@gre@GSMINI", 185);
        p.sendFrame126("@gre@3rdage", 186);
        p.sendFrame126("@gre@Tazahar", 173);
        p.sendFrame126("@gre@Farm", 179);
        p.sendFrame126("@gre@Slayer", 187);
        p.sendFrame126("@gre@Wyvern", 176);
        ...
        p.sendQuest("@gre@Vengeance", 13097);
        p.sendQuest("@whi@multi veng hit", 13098);
        ...
        p.sendQuest("@gre@Level 80 : Vengeance", 1636);
        p.sendQuest("@whi@multi veng hit thing", 1637);
